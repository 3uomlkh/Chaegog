...
class RecipeBookmarkAdapter extends RecyclerView.Adapter<RecipeBookmarkAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public RecipeBookmarkAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
